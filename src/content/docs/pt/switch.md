...
Ele substitui os catálogos de campo em papel pré-formatados e os aplicativos de
formulários customizados sem código, como
[Claris FileMaker](https://www.claris.com/). Esta página compara os três e
descreve como fazer a mudança.
...
| Acesso | Levar o caderno de volta, digitalizar páginas ou redigitar em uma planilha | Abre em qualquer dispositivo e entrega aos colaboradores uma cópia exata |
...
| Associações | O mesmo local reescrito em cada página | Registre um local uma vez e vincule-o a muitos registros, além de coordenadas GPS, imagens e áudio |
...
| Estatísticas | Contagem manual | Resumos ao vivo de espécies, famílias e preservação por projeto e local, exportáveis para uma planilha |
...
|---|---|---|
| Custo | Desenvolvimento e manutenção, muitas vezes com assinatura paga; veja a [página de preços](https://www.claris.com/pricing/) do FileMaker | Gratuito, com o aplicativo e a sua documentação em desenvolvimento ativo |
